    ...
    <div class="row g-0">
        ...
        <div class="col-md-10 main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold">Edit Data Motor</h2>
                <a href="/admin/motor" class="btn btn-secondary"><i class="bi bi-arrow-left me-2"></i>Batal & Kembali</a>
            </div>

            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="/admin/motor/{{ $motor->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="brand" class="form-control" value="{{ $motor->brand }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Tipe/Model</label>
                                <input type="text" name="model" class="form-control" value="{{ $motor->model }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="plate_number" class="form-control" value="{{ $motor->plate_number }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Warna Kendaraan</label>
                                <input type="text" name="color" class="form-control" value="{{ $motor->color }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price" class="form-control" value="{{ $motor->price }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Ganti Foto Motor (Opsional)</label>
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-success px-5"><i class="bi bi-save me-2"></i>Simpan Perubahan</button>
                        </div>
                    </form>
                </div>
            </div>
